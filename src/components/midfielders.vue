...
export default {
    ...
    methods: {
        ...
        async insertFootballer() {
            this.visible = false;
            try {
                const response = await axios.post('http://localhost:3000/api/v1/midfielders', this.newFootballer);
        ...
        async updateFootballer() {
            ...
            try {
                const response = await axios.put(`http://localhost:3000/api/v1/midfielders/${this.footballer.id}`, {
                    ...this.footballer,
        ...
        getFootballers() {
            axios.get('http://localhost:3000/api/v1/midfielders')
            .then(response => {
        ...
        deleteSelectedFootballers() {
            this.selectedFootballers.forEach(id => {
                axios.delete(`http://localhost:3000/api/v1/midfielders/${id}`)
                .then(() => {
                    this.getFootballers();
                })
                .catch(error => {
